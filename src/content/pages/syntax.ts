...
export const pages: GrammarPage[] = [
    ...
    mistakes: [
      {
        ...
        why: "Українська допускає вільніший порядок з відмінками. У нейтральному порядку португальська типово ставить прямий додаток після дієслова; інші порядки можливі через інформаційну структуру, фокус і тип конструкції.",
      },
      {
  ...
  },
  {
    ...
    intro:
      "Підмет часто стоїть перед дієсловом у нейтральній розповіді. Після дієслова він також можливий у конструкціях із дієсловами появи та руху, у цитатах і за певної інформаційної структури; це не одна універсальна схема інверсії.\n\nПропуск підмета — не «інверсія», а нульовий підмет. Це різні явища.",
    ...
    mistakes: [
      {
        ...
        why: "Екзистенційне `haver` у конструкціях типу `há problemas` вживається безособово; іменна група після нього не є звичайним підметом, з яким `haver` узгоджується.",
      },
    ],
    ...
    mistakes: [
      {
        ...
        why: "Надлишковий `eu` може робити контраст із підметом помітнішим або стилістично змінювати фокус. У нейтральному контексті підмет часто можна опустити, якщо його легко відновити з форми дієслова та дискурсу.",
      },
    ],
  ...
  },
  {
    ...
    intro:
      "Сурядність з'єднує рівноправні частини (`e`, `mas`, `ou`, `nem`). Підрядність вбудовує одну клаузу в іншу (`que`, `se`, `quando`, `embora`).\n\nСам по собі тип зв'язку не визначає спосіб дієслова механічно: вибір indicativo / conjuntivo залежить від семантики, лексичного предиката, заперечення, часової та модальної інтерпретації й конкретної конструкції. Підрядні конструкції справді часто створюють середовище для conjuntivo, але це не універсальне правило.",
    examples: [
