    ...
    uses: [
      {
        ...
        examples: [ex("A pessoa que chegou é a minha irmã.", "Людина, яка прийшла, — моя сестра."), ex("A pessoa quem...? ", "У цій позиції без прийменника стандартно потрібна інша структура; не замінюйте que на quem механічно.")],
      },
      {
