...
export const pages: GrammarPage[] = [
  ...
  },
  {
    ...
    examples: [
      ...
      { pt: "Os livros e as revistas são novos.", uk: "Книжки й журнали нові.", note: "Спільне узгодження в чоловічому роді множини." },
      { pt: "Os livros e as revistas são novas.", uk: "Книжки й журнали нові.", note: "В окремих конструкціях можливе узгодження за ближчим іменником; це не слід подавати як універсальне правило." },
    ],
    mistakes: [
      {
  ...
  },
  {
    ...
    examples: [
      { pt: "São três da tarde.", uk: "Третя година дня." },
