...
export const pages: GrammarPage[] = [
  {
    ...
    uses: [
      ...
      {
        title: "Алгоритм розрізнення пасивного й безособового se",
        body: "Якщо після дієслова є іменна група, перевірте її роль. У `V-se + NP` пасивне читання можливе, коли NP є пацієнсом і дієслово узгоджується з ним: `Vendem-se casas`. Якщо конструкція не допускає такого підмета або містить прийменниковий додаток, частіше маємо безособове `se`: `Precisa-se de ajuda`. Не визначайте функцію лише за перекладом «-ся».",
        examples: [
          ex("Vendem-se casas.", "Продаються будинки.", { purpose: "contrast" }),
          ex("Precisa-se de ajuda.", "Потрібна допомога. / Шукають допомогу.", { purpose: "contrast" }),
          ex("Vive-se bem aqui.", "Тут добре живеться.", { purpose: "contrast" }),
        ],
      },
      {
        title: "Узгодження як діагностичний тест",
        body: "Число дієслова є важливим сигналом, але не єдиним тестом. У пасивній конструкції `casas` може спричиняти множинне `vendem-se`; у безособовій конструкції `precisa-se de casas` форма дієслова лишається в однині, бо `de casas` не є підметом. Порівнюйте узгодження з аргументною структурою.",
        examples: [
          ex("Publicam-se artigos.", "Публікуються статті.", { purpose: "comprehension" }),
          ex("Precisa-se de artigos novos.", "Потрібні нові статті.", { purpose: "contrast" }),
        ],
      },
      {
        title: "se як клитик не дорівнює se як сполучник",
        body: "У `se`-підрядному зі значенням умови це сполучник, а не займенниковий клитик: `Se chover, ficamos em casa`. Він не має тієї самої аргументної ролі, що рефлексивне `se` в `Ela lavou-se`. Для розбору спочатку визначте, чи `se` є частиною предикації, чи вводить окрему клаузу.",
        examples: [
          ex("Se chover, ficamos em casa.", "Якщо піде дощ, ми залишимося вдома.", { purpose: "contrast" }),
          ex("Ela lavou-se.", "Вона вмилася.", { purpose: "contrast" }),
        ],
      },
    examples: [
