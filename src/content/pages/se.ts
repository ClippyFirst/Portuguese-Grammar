...
export const pages: GrammarPage[] = [
  ...
  },
  {
    ...
    uses: [
      {
        ...
        examples: [
          ...
          ex("Falam-se inglês e francês.", "Говорять англійською та французькою. / Є англійська й французька."),
    ...
    examples: [
      ...
      ex("Se alugam kitschnet.", "Здаються кімнати з кухнею.", {
        variety: "BR",
        register: "colloquial",
        note: "Прокліза; узгодження в множині збережене.",
      }),
    ],
    ...
    brPt:
      "Пасивне узгодження — спільна письмова норма. У мовленні PT-BR його часто замінює безособова однина або актив з `eles` / `a gente`. PT-PT зберігає `vendem-se` уважніше, особливо на письмі. Позиція: PT-PT `Vendem-se casas`; PT-BR `Se vendem casas` / `Vendem-se casas` на вивісках.",
  },
  {
    id: "se-middle",
    slug: "middle",
