...
export const pages: GrammarPage[] = [
  ...
  },
  {
    ...
    examples: [
      ...
      ex("eventualmente","можливо / за певних обставин; значення залежить від контексту",{ register: "neutral", note: "Не ототожнюйте автоматично з англійським eventually; для значення «зрештою» часто потрібні finalmente / por fim." }),
      ex("pasta","макарони, паста, папка/тека та ін.; значення залежить від контексту й лексичної моделі",{ register: "neutral", note: "Полісемія: контекст визначає значення." }),
    ],
