...
export const pages: GrammarPage[] = [
  ...
  },
  {
    ...
    examples: [
      ...
      ex("eventualmente","можливо / за певних обставин; у стандартному португальському не слід автоматично ототожнювати з англійським eventually"),
      ex("pasta","макарони, паста, папка/тека та ін.; значення залежить від контексту й лексичної моделі"),
    ],
