...
export const pages: GrammarPage[] = [
  page({
    ...
    mistakes: [
      ...
      mistake("перекладати два компоненти окремо й отримувати неіснуючу назву", "вчити складний іменник як цілісну лексему", "Лексикалізація може змінювати значення всієї одиниці.", "editorial", "medium")
    ],
  ...
  page({
    ...
    mistakes: [
      ...
      mistake("використовувати розмовний aumentativo в нейтральному формальному тексті без стилістичної причини", "оцінювати регістр", "Частина форм має виразний розмовний або експресивний характер.", "editorial", "medium")
    ],
  ...
  page({
    ...
    mistakes: [
      ...
      mistake("переносити розмовну модель у формальний документ без перевірки", "аналізувати регістр", "Регіональна варіативність і стилістична маркованість — різні параметри.", "editorial", "medium")
    ],
  ...
  page({
    ...
    mistakes: [
      ...
      mistake("вважати nós і a gente повністю взаємозамінними за стилем", "враховувати регістр і різновид", "Граматичний контраст не зводиться до синонімії.", "editorial", "medium")
    ],
...
,
  ...
  page({
    ...
    mistakes: [
      ...
      mistake("вважати qualquer простим синонімом algum", "розрізняти невизначеність і довільний вибір", "У конкретному контексті значення може бути «будь-хто/будь-який».", "editorial", "medium")
    ],
  ...
  page({
    ...
    mistakes: [
      ...
      mistake("вважати qual повним синонімом que", "розрізняти ідентифікацію та вибір", "qual часто передбачає вибір із набору.", "editorial", "high"),
