...
export const pages: GrammarPage[] = [
  ...
  },
  {
    ...
    brPt: "Форми спільні. `da Maria` vs `de Maria` — наслідок артикля при імені, не наслідок іншої контракції. `preciso do livro` vs BR розмовне `preciso o livro` (без de) — уже регенція, не таблиця do/da.",
    tables: [
      {
