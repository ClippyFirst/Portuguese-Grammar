...
export const pages: GrammarPage[] = [
  {
    ...
    intro:
      "Португальська є плурицентричною мовою: PT-BR і PT-PT мають усталені стандартні норми, а в африканських країнах португаломовного простору також розвиваються національні різновиди та нормативні практики. Для цього довідника PT-BR і PT-PT є головними порівнюваними стандартами; Анголу, Мозамбік та інші різновиди подаємо окремо, коли маємо достатню описову основу.\n\nПлурицентричність означає: різниця — це не помилка іншого. `Estou trabalhando` і `Estou a trabalhar` — обидві нормативні в своїх просторах.\n\nДовідник описує спільне ядро, а відмінності маркує, коли вони граматичні, частотні або реєстрові.",
    examples: [
  ...
  },
  {
    ...
    regional:
      "У школі й адміністрації історично домінував європейський писемний стандарт, водночас національна варіативність посилюється. Контакт із місцевими мовами та медіа впливає на лексику, фонетику й граматичні частотності; конкретні риси треба подавати лише за окремими описами.",
