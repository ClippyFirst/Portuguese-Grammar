...
export const pages: GrammarPage[] = [
  {
    ...
    tables: [
      ...
      },
      {
        ...
        note: "У юридичних і фінансових текстах доцільно дублювати словами цифрою: `1 000 000 000`, якщо шкала може бути неоднозначною.",
        scroll: true,
      },
    ],
  },
  {
    ...
    ukrainian:
      "Українське *перше травня*, *друге травня* всі порядкові. У стандартній даті типовою є модель `primeiro` для 1-го числа, а для наступних дат — кількісні числівники. Це стосується усталеної практики дат, хоча окремі жанри й варіанти можуть мати інші формули.",
    brPt:
  ...
  },
  {
    ...
    intro:
      "Години в португальській — іменник `hora` у потрібному числі, узгоджений з дієсловом: `É uma hora.` `São duas horas.` Це не калька українського *зараз дві години* з середнім родом.\n\nДати будуються з прийменником `em` (скорочено `no dia`, `em 2024`) і кількісним числівником, окрім першого дня місяця. Рік зазвичай без артикля: `em 2024`. День тижня з артиклем може позначати конкретний день/період: `no sábado`; без артикля можливе обставинне вживання. Регулярність має окремі моделі, зокрема `ao sábado` у PT-PT.\n\nPT-BR і PT-PT розходяться в дрібницях на кшталт `quinze para as três` vs `três menos quinze` і в `às 18h` як 6-годинний чи 24-годинний циферблат.",
    formulas: [
      {
        label: "Години",
    ...
    mistakes: [
      ...
      mistake(
        "no segundo de maio",
        "no dia 2 de maio",
        "Після першого числа місяця в датах зазвичай уживають кількісні числівники.",
      ),
    ],
    ukrainian:
