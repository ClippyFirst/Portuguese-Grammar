...
export const pages: GrammarPage[] = [
  {
    ...
    uses: [
      ...
      {
        title: "Географічні назви та власні назви",
        body: "З географічною назвою crase залежить не від того, що це «місце», а від того, чи вживається назва з означеним артиклем і чи керує конструкція прийменником `a`. Тому `vou à França` має іншу структуру, ніж `vou a Portugal`. З особовими іменами артикль також не є автоматичним: спочатку перевіряйте реальне вживання назви.",
        examples: [
          ex("Viajei à França no verão.", "Я подорожував/подорожувала до Франції влітку.", { purpose: "contrast" }),
          ex("Viajei a Portugal no verão.", "Я подорожував/подорожувала до Португалії влітку.", { purpose: "contrast" }),
          ex("Entreguei o documento à Ana.", "Я передав/передала документ Ані.", { note: "Crase можлива, якщо власне ім'я в цьому вживанні допускає артикль." }),
        ],
      },
      {
        title: "Crase після até: не перетворювати варіантність на універсальне правило",
        body: "У конструкціях із `até` трапляються моделі `até à(s)` та `até a(s)`. Їх не слід подавати як одну обов'язкову форму для всіх різновидів і регістрів: описуйте конкретний стандарт і контекст. Це відрізняється від випадків, де `a + a` утворює базову crase без такого варіантного середовища.",
        examples: [
          ex("Ficámos até às seis.", "Ми залишалися до шостої.", { variety: "PT", purpose: "contrast" }),
          ex("Ficámos até as seis.", "Ми залишалися до шостої.", { variety: "BR", purpose: "contrast" }),
        ],
      },
    examples: [
