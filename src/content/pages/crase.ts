    ...
    uses: [
      {
        ...
        body:  "Дієслова з керуванєю `a` (`ir a`, `chegar a`, `voltar a`, `pertencer a`, `obedecer a`, `assistir a` в значенні «дивитися/бути присутнім» у PT-PT, `referir-se a`, `dar a`). Якщо додаток — `a`+жіночий іменник з артиклем, пишемо `à`.",
        examples: [
