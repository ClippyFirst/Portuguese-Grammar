...
export const pages: GrammarPage[] = [
  ...
  },
  {
    ...
    uses: [
      {
        ...
        body:  "Дієслова з керуванням `a` (`ir a`, `chegar a`, `voltar a`, `pertencer a`, `obedecer a`, `assistir a` в значенні «дивитися/бути присутнім» у PT-PT, `referir-se a`, `dar a`). Якщо додаток — `a`+жіночий іменник з артиклем, пишемо `à`.",
        examples: [
    ...
    exceptions: "Навіть «обов'язкові» зони скасовуються, якщо артикль зникає: `ir a Lisboa` (місто без артикля), `assistir a espetáculos` (гола множина / нуль у деяких уживаннях), `chegar a casa` (ідіома).\n\n`assistir o jogo` без `a` — поширена керування PT-BR («дивитися гру» з прямим додатком). Тоді crase немає, бо немає прийменника. PT-PT частіше `assistir ao jogo` / `à peça`. Різниця керування, не різний знак crase.",
    mistakes: [
      mistake(
        "Cheguei a conclusão.",
        "Cheguei à conclusão.",
  ...
  },
  {
    ...
    intro: "Шкільна тріада Бразилії — obrigatória / facultativa / proibida — зручна, якщо не перетворювати її на магію. Факультативність з'являється там, де **артикля можна не бути**: жіноче особове ім'я, присвійний (особливо з огляду на PT-BR), деякі `até a`. Заборона — там, де другого `a` немає в принципі.\n\nФакультативне `à` не означає «ставте, щоб виглядало розумніше». Якщо ви пишете PT-BR з голим ім'ям, логічніше `a Maria`. Якщо пишете PT-PT з `a Maria` як артикль+ім'я після прийменника — `à Maria`.",
    formulas: [
      {
    ...
    mistakes: [
      ...
      mistake(
        "A aluna, vi-à ontem.",
        "A aluna, vi-a ontem.",
        "Тут a — клитик (її), не прийменник+артикля. Клитик ніколи не отримує гравіса crase.",
      ),
      mistake(
