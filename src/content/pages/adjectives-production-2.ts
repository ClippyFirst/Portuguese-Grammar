...
export const pages: GrammarPage[] = [
  ...
  page({
    ...
    related: ["adjective-agreement", "adjective-position", "coordinating", "noun-adjective-agreement"],
    status: "draft", origin: "handwritten", depth: "high", ukrainianContrast: "high",
  ...
  page({
    ...
    related: ["word-formation-overview", "adjective-agreement", "hyphenation", "adjectivisation"],
    status: "draft", origin: "handwritten", depth: "high", ukrainianContrast: "high",
