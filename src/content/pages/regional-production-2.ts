...
export const pages: GrammarPage[] = [
  ...
  page({
    ...
    related: ["sentence-basics", "speech-acts", "rhetorical-questions", "imperative-softening-intensification"],
    status: "draft", origin: "handwritten", depth: "high", ukrainianContrast: "high",
  ...
  page({
    ...
    related: ["sentence-basics", "question-word-order", "exclamatives", "sentence-type-vs-speech-act"],
    status: "draft", origin: "handwritten", depth: "high", ukrainianContrast: "high",
  ...
  page({
    ...
    related: ["sentence-basics", "punctuation", "sentence-type-vs-intonation", "exclamatives"],
    status: "draft", origin: "handwritten", depth: "high", ukrainianContrast: "high",
