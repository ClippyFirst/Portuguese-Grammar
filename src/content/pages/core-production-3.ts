...
export const pages: GrammarPage[] = [
  ...
  page({
    ...
    definition: "Нульовий обліковий/непрямий аргумент — невиражений аргумент, який у повній конструкції реалізувався б як прийменникова група або інший обліковий додаток.",
    uses: [
