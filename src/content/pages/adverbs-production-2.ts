...
export const pages: GrammarPage[
  page({
    ...
    titleUk: "Система прислівників", titlePt: "Sistema dos advérbios", titleEn: "Adverb system overview",
    summary: "Система португальських прислівників: клас, функції, утворення та межі категорії.",
    aliases: ["система прислівників", "adverbs overview", "sistema dos advérbios"],
    related: ["adverbs-vs-adjectives", "adverb-formation", "adverb-position", "adverb-scope"],
    status: "review", origin: "handwritten", depth: "high", ukrainianContrast: "high",
    intro: "Португальський прислівник не є одним однорідним класом зі значенням «як?». До прислівникової сфери належать модифікатори способу, часу, місця, частотності, ступеня, кількості, фокусу, оцінки та ставлення мовця. Окремо існують прислівникові сполуки. Для аналізу важливо встановлювати не лише лексичну форму, а й область дії, синтаксичну позицію, семантичну функцію та регістр.",
    definition: "Прислівник — незмінний лексико-граматичний елемент, який може модифікувати дієслово, прикметник, інший прислівник або ширший компонент речення; прислівникова функція також може реалізуватися багатослівною сполукою.",
    formulas: [
      { label: "Дія", pattern: "V + ADV", note: "Модифікація способу, частотності, часу тощо." },
      { label: "Ознака", pattern: "ADV + ADJ", note: "Типова модель ступеня або міри." },
      { label: "Інший прислівник", pattern: "ADV + ADV", note: "Один модифікатор задає ступінь іншого." },
      { label: "Речення", pattern: "ADV + oração", note: "Епістемічні, оцінні та дискурсивні прислівники можуть мати широку область дії." }
    ],
    formation: "Португальські прислівники представлені як простими лексемами, так і похідними формами, особливо на -mente, а також локціями. Межа між прислівником і прислівниковою функцією принципова: прийменникова група може виконувати прислівникову роль, не стаючи одним прислівником.",
    uses: [
      { title: "Модифікація дієслова", body: "Прислівник може описувати спосіб, час, місце або частотність дії.", examples: [ex("Ela trabalha cuidadosamente.", "Вона працює уважно.", { purpose: "production" })] },
      { title: "Модифікація прикметника", body: "Ступеневі прислівники визначають міру ознаки.", examples: [ex("É muito interessante.", "Це дуже цікаво.", { purpose: "comprehension" })] },
      { title: "Модифікація висловлення", body: "Епістемічний або оцінний прислівник може коментувати всю пропозицію.", examples: [ex("Provavelmente, ele chega amanhã.", "Імовірно, він приїде завтра.", { purpose: "contrast" })] },
      { title: "Прислівникова сполука", body: "Багатослівний вираз може виконувати ту саму функцію.", examples: [ex("De manhã, trabalho em casa.", "Вранці я працюю вдома.", { purpose: "comprehension" })] }
    ],
    examples: [
      ex("Ela trabalha cuidadosamente.", "Вона працює уважно.", { purpose: "production", function: "модифікація способу" }),
      ex("É muito interessante.", "Це дуже цікаво.", { purpose: "production", function: "ступінь ознаки" }),
      ex("Provavelmente, ele chega amanhã.", "Імовірно, він приїде завтра.", { purpose: "contrast", function: "епістемічна оцінка" }),
      ex("De manhã, trabalho em casa.", "Вранці я працюю вдома.", { purpose: "comprehension", function: "часова характеристика" })
    ],
    nonUses: [
      "Не визначайте частину мови лише за українським перекладом: одна португальська форма може мати різні функції.",
      "Не ототожнюйте будь-яку обставину з морфологічним прислівником: прислівникову функцію можуть виконувати групи.",
      "Не робіть висновок про допустиму позицію тільки з одного прикладу: область дії та інформаційна структура впливають на розташування."
    ],
    markers: ["muito", "pouco", "sempre", "nunca", "aqui", "lá", "assim", "provavelmente", "-mente"],
    mistakes: [
      mistake("вважати прислівник прямим відповідником одного українського прислівника", "визначати функцію, область дії та тип модифікованого компонента", "Українська й португальська мають подібну категорію, але не однаково розподіляють значення між формами."),
      mistake("називати прийменникову групу одним прислівником", "розрізняти морфологічний клас і синтаксичну функцію", "Наприклад, de manhã є багатослівним виразом із прислівниковою функцією."),
      mistake("вивчати всі прислівники без урахування регістру", "перевіряти, чи форма нейтральна, розмовна, формальна або стилістично маркована", "Прислівникова система включає різні дискурсивні та стилістичні функції.")
    ],
    ukrainian: "Українська також має широкий клас прислівників і прислівникових сполук, тому базова категорія добре зіставляється. Відмінності виникають у словотворі, позиції, області дії, класифікації окремих форм та способах вираження тієї самої функції.",
    comparisonUk: "Українське «дуже», «завжди», «тут», «уважно» зручно використовувати як семантичні орієнтири, але не як формальні шаблони. Португальське muito може модифікувати дію або ступінь прикметника; українські переклади тоді розходяться. Аналогічно, українське «вранці» може відповідати португальському de manhã, хоча формально це не одна й та сама частина мови.",
    regional: "Основний набір прислівникових категорій є спільним для португаломовного простору, але конкретні форми, позиційні переваги, частотність і регістр можуть відрізнятися. PT-BR та PT-PT не слід описувати як дві взаємовиключні прислівникові системи; варіацію треба прив'язувати до конкретної конструкції та джерела.",
    sources: [
  ...
  page({
    ...
    related: ["adverbs-overview", "adverb-position", "prepositions-overview"],
...
,
  page({
    ...
    related: ["adverb-position", "scope-and-reference", "scope-and-reference", "adverbs-degree"],
    status: "draft", origin: "handwritten", depth: "high", ukrainianContrast: "high",
