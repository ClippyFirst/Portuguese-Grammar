...
export const pages: GrammarPage[] = [
  page({
    ...
    mistakes: [
      ...
      mistake("запам'ятовувати слово без типових партнерів", "додавати до картки приклади з керуванням і колокаціями", "Контекст показує, як слово реально функціонує.", "pedagogical", "medium")
    ],
  ...
  page({
    ...
    mistakes: [
      ...
      mistake("плутати fazer, tomar, dar, ter лише за загальним значенням", "вивчати дієслово разом із типовим іменником", "Значення в колокації формується конструкцією.", "pedagogical", "high"),
  ...
  page({
    ...
    mistakes: [
      ...
      mistake("вчити список без контексту", "вчити слово в типовій фразі", "Конструкція часто одразу показує справжнє значення.", "pedagogical", "medium")
    ],
