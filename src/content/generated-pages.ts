...
"verb-government-infinitive": {
  ...
  "verb-government-alternations": {
    ...
    learnerQuestions: ["Чи змінюється значення або структура при появі se?", "Який тип complement вимагає дієслово?", "Чи підтверджена ця рамка для потрібного різновиду та регістру?", "Чи є альтернативна рамка справді синонімічною?"]
  },
