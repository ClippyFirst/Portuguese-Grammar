...
Object.assign(SPECIAL, {
  "verb-valency-arguments": {
    formulas: [{ pattern: "V + argument₁ + argument₂ → semantic role + syntactic realization", note: "Аргумент — компонент, який вибирається предикатом; його роль (agent, theme, recipient, experiencer тощо) не зводиться до українського відмінка." }],
    formation: "Для аналізу рамки спочатку визначте значення дієслова, потім кількість аргументів, їхні семантичні ролі, синтаксичну реалізацію (NP/PP/clause) і, якщо є, прийменник та клітику.",
    examples: [
      { pt: "A Maria abriu a porta.", uk: "Марія відчинила двері.", note: "Підмет — агенс; a porta — прямий додаток/тема." },
      { pt: "O João deu o livro à Ana.", uk: "Жуан дав книжку Ані.", note: "Аргументи: переданий об'єкт і адресат; à = a + a." },
      { pt: "A Maria confia no João.", uk: "Марія довіряє Жуану.", note: "no João — прийменниковий аргумент, вибраний дієсловом confiar." },
      { pt: "O professor explicou que a aula começaria às oito.", uk: "Викладач пояснив, що заняття почнеться о восьмій.", note: "Que-clause реалізує доповнення дієслова explicar." }
    ],
    mistakes: [{ wrong: "Називати будь-який компонент після дієслова «прямим додатком».", right: "Встановлювати роль і спосіб реалізації кожного аргументу.", why: "Позиція після дієслова не визначає синтаксичну функцію: аргумент може бути NP, PP або підрядною частиною." }],
    ukrainian: "Українські відмінки часто кодують ролі, які в португальській виражаються прийменниковими групами або окремими клітиками. Тому порівнюйте роль і конструкцію, а не лише питання «кого? чого?».",
    learnerQuestions: ["Скільки аргументів вибирає саме це значення дієслова?", "Яку семантичну роль має кожен аргумент?", "Як аргумент реалізований: NP, PP, клауза чи інфінітив?", "Чи змінюється рамка при зміні значення або різновиду мови?"]
  }
});
