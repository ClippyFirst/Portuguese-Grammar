...
> **Coverage scope is now governed by `docs/CANONICAL-GRAMMAR-INVENTORY.md`. It contains 875 canonical coverage units; these are ontology units, not 742 mandatory URLs.**
